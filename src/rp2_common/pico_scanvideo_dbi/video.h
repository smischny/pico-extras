...
#ifdef REORDER_RED
#define  REORDER_R(r) ((((r) & 1) << 4) | (((r) & 2) << 2) | (((r) & 4) << 1) | (((r) & 8) << 2) | (((r) & 16) << 4))
#else
#define  REORDER_R(r) (r)
#endif

#define PICO_SCANVIDEO_PIXEL_FROM_RGB8(r, g, b) ((((b)>>3)<<PICO_SCANVIDEO_PIXEL_BSHIFT)|(((g)>>3)<<PICO_SCANVIDEO_PIXEL_GSHIFT)|((REORDER_R((r)>>3))<<PICO_SCANVIDEO_PIXEL_RSHIFT))
#define PICO_SCANVIDEO_PIXEL_FROM_RGB5(r, g, b) (((b)<<PICO_SCANVIDEO_PIXEL_BSHIFT)|((g)<<PICO_SCANVIDEO_PIXEL_GSHIFT)|((REORDER_R(r))<<PICO_SCANVIDEO_PIXEL_RSHIFT))
